...
type Product = {
  title: string;
  link: string;
  thumbnail: string; // Ensure this is a string
};
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold text-[#5f5f61]">
        Mission <br /> Statement
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-[#5f5f61]">
    ...
    >
      ...
      >
        <Image
          ...
          height="600"
          width="600"
          className="object-cover opacity-70 rounded-xl object-left-top absolute h-full w-full inset-0"
          alt={product.title}
        />
      </Link>
